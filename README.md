...
本ポートフォリオは、Web 開発 3 年目の自称フルスタックエンジニアよるポートフォリオです。
...
良さげな題材が思いつかなかったので大学時代に所属していた軽音楽サークルのOB・OGライブの Youtubeリンク を CRUD できる管理画面のようなものを作ってみました。
...
vite を使うことでホットリロードや高速デプロイを実現しています。

メンバーによりよい開発者体験をもたらし、プロジェクトにスピード感を持たせることができます。


もはやホットリロードなしで開発など考えられません。
...
## DynamoEasy でより簡易に DynamoDB とやりとりする
